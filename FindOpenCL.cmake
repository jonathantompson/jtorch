# FROM:
# github.com/elhigu/cmake-findopencl/blob/master/cmake/FindOpenCL.cmake
#
# Find OpenCL
#
...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		IF (DEFINED ENV{CUDA_INC_PATH})
			MESSAGE("Using NVIDIA cuda sdk for OpenCL library")
			SET(OPENCL_INCLUDE_SEARCH_PATHS ${OPENCL_INCLUDE_SEARCH_PATHS} $ENV{CUDA_INC_PATH})
			SET(OPENCL_LIBRARY_64_SEARCH_PATHS ${OPENCL_LIBRARY_64_SEARCH_PATHS} $ENV{CUDA_LIB_PATH})
			SET(OPENCL_LIBRARY_SEARCH_PATHS ${OPENCL_LIBRARY_SEARCH_PATHS} $ENV{CUDA_LIB_PATH})
		ENDIF()

		# Intel SDK
		IF (DEFINED ENV{INTELOCSDKROOT})
			MESSAGE("Using Intel sdk for OpenCL library")
		...
		IF (DEFINED ENV{AMDAPPSDKROOT})
			MESSAGE("Using AMD sdk for OpenCL library")
