...
class JCL {
 public:
  ...
  JCL(const CLDevice device = CLDeviceCPU, const CLVendor vendor = CLVendorAny,
  ...
  void useKernel(const char* filename,
                 const char* kernel_name);  // USE THIS VERSION
  void useKernelCStr(const char* kernel_c_str,
                     const char* kernel_name);  // SLOWER
